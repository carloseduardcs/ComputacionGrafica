...
#define MAX_FRAMES 10 ///cantidad de frames
int i_max_steps = 900;
int i_curr_steps = 0;
...
void saveFrame ( void )
{
	...
	KeyFrame[FrameIndex].indice = indice;
	KeyFrame[FrameIndex].indice1 = indice1;
	
	KeyFrame[FrameIndex].pulgar = pulgar;
	KeyFrame[FrameIndex].pulgar1 = pulgar1;

	KeyFrame[FrameIndex].medio = medio;
	KeyFrame[FrameIndex].medio1 = medio1;

	KeyFrame[FrameIndex].anular = anular;
	KeyFrame[FrameIndex].anular1 = anular1;

	KeyFrame[FrameIndex].mov1 = mov1;
	KeyFrame[FrameIndex].mov2 = mov2;

	KeyFrame[FrameIndex].inicial = inicial;
...
void resetElements( void )
{
	...
	indice1 = KeyFrame[0].indice1;

	pulgar = KeyFrame[0].pulgar;
	pulgar1 = KeyFrame[0].pulgar1;
	
	medio = KeyFrame[0].medio;
	medio1 = KeyFrame[0].medio1;

	anular = KeyFrame[0].anular;
	anular1 = KeyFrame[0].anular1;

	mov1 = KeyFrame[0].mov1;
	mov2 = KeyFrame[0].mov2;

	inicial = KeyFrame[0].inicial;
...
void interpolation ( void )
{
	...
	KeyFrame[playIndex].indiceInc = (KeyFrame[playIndex + 1].indice - KeyFrame[playIndex].indice) / i_max_steps;
	KeyFrame[playIndex].indice1Inc = (KeyFrame[playIndex + 1].indice1 - KeyFrame[playIndex].indice1) / i_max_steps;

	KeyFrame[playIndex].pulgarInc = (KeyFrame[playIndex + 1].pulgar - KeyFrame[playIndex].pulgar) / i_max_steps;
	KeyFrame[playIndex].pulgar1Inc = (KeyFrame[playIndex + 1].pulgar1 - KeyFrame[playIndex].pulgar1) / i_max_steps;

	KeyFrame[playIndex].medioInc = (KeyFrame[playIndex + 1].medio - KeyFrame[playIndex].medio) / i_max_steps;
	KeyFrame[playIndex].medio1Inc = (KeyFrame[playIndex + 1].medio1 - KeyFrame[playIndex].medio1) / i_max_steps;

	KeyFrame[playIndex].anularInc = (KeyFrame[playIndex + 1].anular - KeyFrame[playIndex].anular) / i_max_steps;
	KeyFrame[playIndex].anular1Inc = (KeyFrame[playIndex + 1].anular1 - KeyFrame[playIndex].anular1) / i_max_steps;

	KeyFrame[playIndex].mov1Inc = (KeyFrame[playIndex + 1].mov1 - KeyFrame[playIndex].mov1) / i_max_steps;
	KeyFrame[playIndex].mov2Inc = (KeyFrame[playIndex + 1].mov2 - KeyFrame[playIndex].mov2) / i_max_steps;

	KeyFrame[playIndex].inicialInc = (KeyFrame[playIndex + 1].inicial - KeyFrame[playIndex].inicial) / i_max_steps;
	...
	glPushMatrix();//Pecho
		...
		glPushMatrix(); //Brazo derecho-->
			...
			glPushMatrix();
				...
				glRotatef(-45, 0, 1, 0); 
				glRotatef(movbrazo, 0.0, 0.0, 1.0);   
...
void brazo(void) {
	...
	glTranslatef(1.0, 0.0, 0.0);           
		...
		glPushMatrix();                          
			...
			glRotatef(indice, 0.0, 0.0, 1.0); 
			glTranslated(0.375, 0.0, 0.0);      
				glPushMatrix();
		...
		glPushMatrix();                           
			glTranslatef(1.0, -0.35, 0.375);    
			glRotatef(pulgar, 0.0, 1.0, 0.0); 
			glRotatef(inicial, 0.0, 1.0, 0.0);
			glTranslated(0.375, 0.0, 0.0);   
			glPushMatrix();
				glScalef(0.75, 0.3, 0.25);
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	objCamera.Position_Camera(-5, 5, 3, -5, 5, 0, 0, 1, 0);
	...
	for (int i = 0; i<MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].movpiernader = 0;
		KeyFrame[i].movpiernaderInc = 0;

		KeyFrame[i].indice = 0;
		KeyFrame[i].indiceInc = 0;
		KeyFrame[i].indice1 = 0;
		KeyFrame[i].indice1Inc = 0;
		KeyFrame[i].pulgar = 0;
		KeyFrame[i].pulgarInc = 0;
		KeyFrame[i].pulgar1 = 0;
		KeyFrame[i].pulgar1Inc = 0;
		KeyFrame[i].medio = 0;
		KeyFrame[i].medioInc = 0;
		KeyFrame[i].medio1 = 0;
		KeyFrame[i].medio1Inc = 0;
		KeyFrame[i].anular = 0;
		KeyFrame[i].anularInc = 0;
		KeyFrame[i].anular1 = 0;
		KeyFrame[i].anular1Inc = 0;
		KeyFrame[i].mov1 = 0;
		KeyFrame[i].mov1Inc = 0;
		KeyFrame[i].mov2 = 0;
		KeyFrame[i].mov2Inc = 0;
		KeyFrame[i].inicial = 0;
		KeyFrame[i].inicialInc = 0;
	}
	/* FRAMES*/
	...
	KeyFrame[0].posY = 2.5;
	KeyFrame[0].posZ = -3.5;
	KeyFrame[0].indice = -20;
	KeyFrame[0].indice1 = -2;
	KeyFrame[0].pulgar = -2;
	KeyFrame[0].pulgar1 = -2;
	KeyFrame[0].medio = -2;
	KeyFrame[0].medio1 = 0;
	KeyFrame[0].anular = -2;
	KeyFrame[0].anular1 = 0;
	KeyFrame[0].mov1 = 0.20;
	KeyFrame[0].mov2 = -0.20;
	KeyFrame[0].inicial = 2;
	...
	KeyFrame[2].posZ = -3.5;
	KeyFrame[2].indice = 0;
	KeyFrame[2].indice1 = -112;
	KeyFrame[2].pulgar = 0;
	KeyFrame[2].pulgar1 = 62;
	KeyFrame[2].medio = 0;
	KeyFrame[2].medio1 = -112;
	KeyFrame[2].anular = 0;
	KeyFrame[2].anular1 = -112;
	KeyFrame[2].mov1 = 0;
	KeyFrame[2].mov2 = 0;
	KeyFrame[2].inicial = 0;
	...
	KeyFrame[3].posZ = -3.5;
	KeyFrame[3].indice = 0;
	KeyFrame[3].indice1 = 0;
	KeyFrame[3].pulgar = -39;
	KeyFrame[3].pulgar1 = 0;
	KeyFrame[3].medio = 0;
	KeyFrame[3].medio1 = 0;
	KeyFrame[3].anular = 0;
	KeyFrame[3].anular1 = 0;
	KeyFrame[3].mov1 = 0;
	KeyFrame[3].mov2 = 0;
	KeyFrame[3].inicial = 0;
	...
	KeyFrame[1].posZ = -3.5;
	KeyFrame[1].indice = 0;
	KeyFrame[1].indice1 = 0;
	KeyFrame[1].pulgar = 42;
	KeyFrame[1].pulgar1 = 0;
	KeyFrame[1].medio = 0;
	KeyFrame[1].medio1 = 0;
	KeyFrame[1].anular = -30;
	KeyFrame[1].anular1 = -112;
	KeyFrame[1].mov1 = -10.19;
	KeyFrame[1].mov2 = 10.19;
	KeyFrame[1].inicial = 0;

	//Frame LIKE
	KeyFrame[4].posX = 0;
	KeyFrame[4].posY = 2.5;
	KeyFrame[4].posZ = -3.5;
	KeyFrame[4].indice = -52;
	KeyFrame[4].indice1 = -102;
	KeyFrame[4].pulgar = -93;
	KeyFrame[4].pulgar1 = 2;
	KeyFrame[4].medio = -44;
	KeyFrame[4].medio1 = -128;
	KeyFrame[4].anular = -65;
	KeyFrame[4].anular1 = -116;
	KeyFrame[4].mov1 = -2;
	KeyFrame[4].mov2 = 0;
	KeyFrame[4].inicial = 0;
...
void animacion()
{
	...
	{		
		...
		else
		{
			...
			indice1 += KeyFrame[playIndex].indice1Inc;

			pulgar += KeyFrame[playIndex].pulgarInc;
			pulgar1 += KeyFrame[playIndex].pulgar1Inc;

			medio += KeyFrame[playIndex].medioInc;
			medio1 += KeyFrame[playIndex].medio1Inc;

			anular += KeyFrame[playIndex].anularInc;
			anular1 += KeyFrame[playIndex].anular1Inc;

			mov1 += KeyFrame[playIndex].mov1Inc;
			mov2 += KeyFrame[playIndex].mov2Inc;

			inicial += KeyFrame[playIndex].inicialInc;

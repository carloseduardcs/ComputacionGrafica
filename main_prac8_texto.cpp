...
void prisma1(GLuint textura1, GLuint textura2)  //Funcion creacion prisma !DADO PRISMA ¡
{
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		glPushMatrix();// A
		glBindTexture(GL_PROXY_TEXTURE_2D, dado.GLindex);
		glColor3f(1.0, 1.0, 1.0);
		glTranslatef(0.0, 0.0, 0.0);
		glScalef(8.0, 3.0, 0.5);
		prisma1(madera.GLindex, madera.GLindex);
		glPopMatrix();
		...
		glAlphaFunc(GL_GREATER, 0.1);//transparencia
		prisma(madera.GLindex, ventana.GLindex);
		...
		glBindTexture(GL_PROXY_TEXTURE_2D, dado.GLindex);
		glColor3f(1.0, 1.0, 1.0);
		glTranslatef(-3.5, 2.0, 4.0);
		glScalef(1.0, 5.0, 7.5);
		prisma1(madera.GLindex, madera.GLindex);
		glPopMatrix();
		...
		prisma(puerta.GLindex, madera.GLindex);
		glPopMatrix();

		glPushMatrix();// ventana
		glBindTexture(GL_PROXY_TEXTURE_2D, dado.GLindex);
		glColor3f(1.0, 1.0, 1.0);
		glTranslatef(3.5, 2.5, 6.5);
		glScalef(1.0, 2.0, 2.0);
		glEnable(GL_ALPHA_TEST);//transparencia
		glAlphaFunc(GL_GREATER, 0.1);//transparencia
		prisma(ventana.GLindex, madera.GLindex);
		glDisable(GL_ALPHA_TEST);
		glPopMatrix();
		...
		glBindTexture(GL_PROXY_TEXTURE_2D, dado.GLindex);
		glColor3f(1.0, 1.0, 1.0);
		glTranslatef(3.5, 0.5, 6.5);
		glScalef(1.0, 2.0, 2.5);
		...
		glScalef(10.0, 5.0, 8.0);
		triangulo(madera.GLindex);
		glPopMatrix();
